    ...
    return (
      <div className="aboutPageContainer">
        <div className="aboutContainer">
          ...
          <p className="aboutText">Glen is a seminar speaker at the largest Sportsmen shows in the Northwest for the past 30 years. Glen’s creative call designs lead to innovation for Berry Game Calls, hunters have been using these calls for the past 30 years with great success.</p>
          <p className="aboutText">Glen and Liz Berry established Berry Game Calls in 1983.</p>
        </div>
      </div>
    );
  }
